...
vim.keymap.set({"n", "v"}, "<C-j>", "<C-w>j", { desc = "Ctrl + j in Normal or Visual Mode - go to bottom split" })
vim.keymap.set({"n", "v"}, "<C-k>", "<C-w>k", { desc = "Ctrl + k in Normal or Visual Mode - go to top split" })
vim.keymap.set({"n", "v"}, "<C-h>", "<C-w>h", { desc = "Ctrl + h in Normal or Visual Mode - go to left split" })
vim.keymap.set({"n", "v"}, "<C-l>", "<C-w>l", { desc = "Ctrl + l in Normal or Visual Mode - go to right split" })
